...
class InferenceEngine(abc.ABC):
    ...
    def state_dict(self) -> Dict[str, Any]:
        """Get the state dictionary of the inference engine."""
        raise NotImplementedError()
    ...
    def recover(
        ...
        # Submit leftover data for inference engine according to state
        """Recover the inference engine state from a dataloader."""
        raise NotImplementedError()
