...
@dataclass
class RLVRWorkflowConfig:
    gconfig: GenerationHyperparameters = field(
        default_factory=GenerationHyperparameters,
        metadata={
            "help": "Generation hyperparameters for RLVR workflow. "
            "These parameters control the text generation behavior during RL training."
        },
    )
    success_rate_ub: float = field(
        default=0.95,
        metadata={
            "help": "Upper bound for success rate. "
            "If the success rate exceeds this value, data generated by this workflow will be discarded."
        },
    )
    success_rate_lb: float = field(
        default=0.05,
        metadata={
            "help": "Lower bound for success rate. "
            "If the success rate is below this value, data generated by this workflow will be discarded."
        },
    )
    max_prompt_len: int = field(
        ...
        metadata={
            ...
            "If the prompt exceeds this length, it will be truncated."
        },
    )
    enable_thinking: bool = field(
        ...
        metadata={
            ...
            "If True, the workflow will generate thinking steps during text generation."
        },
    )
...
class RecoverConfig(_Timer):
    mode: str = field(
        ...
        metadata={
            ...
            "'resume': Force to resume, raise an error if no recover info is found. "
        },
    )
    retries: int = field(
        default=3,
...
class GRPOConfig(BaseExperimentConfig):
    ...
    rlvr: RLVRWorkflowConfig = field(default_factory=RLVRWorkflowConfig)
    rlvr_test: RLVRWorkflowConfig = field(default_factory=RLVRWorkflowConfig)
